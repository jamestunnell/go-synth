...
func TestSine(t *testing.T) {
	...
	assert.InDelta(t, 0.951057, outBuf[1], 1e-3)
	assert.InDelta(t, 0.587785, outBuf[2], 1e-3)
	assert.InDelta(t, -0.587785, outBuf[3], 1e-3)
	assert.InDelta(t, -0.951057, outBuf[4], 1e-3)
